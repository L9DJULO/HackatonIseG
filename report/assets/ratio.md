...
En ordres de grandeur, le constat est d'une autre nature : **nos 12 configurations sont TOUTES dans la même tranche, $10^{2}$**, de 163 à 939 paramètres. Le critère ne les départage donc pas, et il n'a pas à le faire : à l'intérieur d'une tranche, c'est le Dice qui décide. Le meilleur est « configuration finale + auto-contexte à deux étages » à 0.8399.

Le critère ne dit quelque chose que lorsque la tranche change. C'est le cas contre le challenge, dont les méthodes publiées sont en $10^6$ et $10^7$, soit quatre à cinq tranches au-dessus. Et c'est le cas contre le classifieur dégénéré, quatre tranches en dessous : son Dice de 0.21 l'élimine immédiatement, ce qu'aucun ratio brut ne faisait.
